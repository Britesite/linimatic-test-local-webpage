      ...
      <div className="mx-auto max-w-[1800px] px-6 sm:px-10 lg:px-16 xl:px-20">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3 xl:gap-4">
            ...
            <Link
              href="/contact"
              className="relative px-3.5 min-[1700px]:px-6 py-2.5 text-[12px] min-[1700px]:text-[13px] font-semibold tracking-wide uppercase text-zinc-950 rounded-md bg-ember hover:bg-ember-light transition-colors whitespace-nowrap"
            >
              {t("getQuote")}
            </Link>
          </div>
