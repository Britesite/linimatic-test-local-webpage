          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-8 lg:gap-x-16 items-center">
            <div className="lg:col-start-1 lg:row-start-1 lg:self-end">
              ...
              <h1 className="animate-fade-up delay-1">
                <span className="block text-6xl sm:text-7xl lg:text-[5rem] xl:text-[6.25rem] font-bold text-zinc-900 hyphens-auto [overflow-wrap:break-word] leading-[0.92] tracking-[-0.03em] font-[family-name:var(--font-display)]">
                  {t('hero.headline1')}
                </span>
                <span className="block text-6xl sm:text-7xl lg:text-[5rem] xl:text-[6.25rem] font-bold hyphens-auto [overflow-wrap:break-word] leading-[0.92] tracking-[-0.03em] font-[family-name:var(--font-display)] mt-1">
